...
del out_build\clip_5b.o
del out_build\clip_5b.nes
del out_build\clip_5b_nrom.nes
del out_build\clip_5b.nsf
del out_build\clip_5b.dbg
del out_build\clip_5b.map.txt
