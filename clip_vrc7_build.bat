...
del out_build\clip_vrc7.o
del out_build\clip_vrc7.nes
del out_build\clip_vrc7_nrom.nes
del out_build\clip_vrc7.nsf
del out_build\clip_vrc7.dbg
del out_build\clip_vrc7.map.txt
